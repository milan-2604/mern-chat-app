    ...
    > 
      <div className="border-b border-base-300 w-full p-5">
        <div className="flex items-center gap-2">
          ...
          {/* 🛠️ POLISH: Visible on mobile full screen, hidden on tablet views, visible on desktop */}
          <span className="font-medium block md:hidden lg:block">Contacts</span>
        </div>
        
        {/* 🛠️ POLISH: Visible on mobile full screen, hidden on tablet views, flex on desktop */}
